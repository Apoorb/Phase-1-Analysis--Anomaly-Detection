...
if Is_Cov:
    ...
    X_std = StandardScaler().fit_transform(X)  #Correlation
...
if Is_Cov:
    ...
    fig.savefig("ParetoPlt_Cor.png") #Correlation


# Scree Plot
Sns_dt3=pd.DataFrame({'x1':[(i+1) for i in range(0,Ncomp)],'y1':sorted(eig_vals, reverse=True)[:Ncomp]})
...
if Is_Cov:
    ...
    fig2.savefig("ScreePlt_Cor.png") #Correlation
...
if Is_Cov:
    principalDf.to_csv("PrinCompDat_Covar.csv")
else:
    principalDf.to_csv("PrinCompDat_Correl.csv") #Correlation
